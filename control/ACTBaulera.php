    ...
    function listarBaulera()
    {
        ...
        if ($this->objParam->getParametro('id_condominio') != '') {
            ...
            if ($this->objParam->getParametro('es_propietario') == 'si') {
                $this->objParam->addFiltro("bau.id_baulera not in (select bp.id_baulera
                                                                    from ate.tbaulera_propietario bp
                                                                             join ate.tbaulera bau on bau.id_baulera = bp.id_baulera
                                                                    where bau.id_condominio = " . $this->objParam->getParametro('id_condominio') . " )");
            }
