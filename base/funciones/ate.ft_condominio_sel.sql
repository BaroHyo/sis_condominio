CREATE OR REPLACE FUNCTION "ate"."ft_condominio_sel"(    
...
COST 100;
ALTER FUNCTION "ate"."ft_condominio_sel"(integer, integer, character varying, character varying) OWNER TO postgres;
